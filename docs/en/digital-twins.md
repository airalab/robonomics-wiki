...
* **Topic name** - is 0x prefixed `H256 hex` or `ascii data` with 32 characters length. For example: `0x1234....FF` and  `hello.parachain.robonomics.world`.
