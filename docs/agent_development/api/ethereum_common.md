...
The packages contains two launch files: `erc20.launch` and `signer.launch`. The last one is included in [Robonomics Liability](robonomics_liability.md).
...
The event [ethereum_common/TransferEvent](ethereum_common_msgs.md#ethereum_commontransfereventmsg) is emitted after the transfer of tokens was made

### /eth/event/approval (ethereum_common/ApprovalEvent)

The event [ethereum_common/ApprovalEvent](ethereum_common_msgs.md#ethereum_commonapprovaleventmsg) is emitted after the approval of tokens was made
...
List of available Ethereum accounts. See [ethereum_common/Accounts](ethereum_common_msgs.md#ethereum_commonaccountssrv)

### /eth/account_eth_balance (ethereum_common/AccountBalance)

Returns the balance of the given address in Wei. See [ethereum_common/AccountBalance](ethereum_common_msgs.md#ethereum_commonaccountbalancesrv)
